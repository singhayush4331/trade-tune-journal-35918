...
const EnhancedSidebar: React.FC<EnhancedSidebarProps> = ({
  ...
  // Debug lesson types
  React.useEffect(() => {
    console.log('Enhanced Sidebar - Debug lesson types:');
  ...
  const completionStreak = 3; // This would come from actual user data
  ...
  const handleLessonClick = (moduleIndex: number, lessonIndex: number) => {
    console.log('Enhanced sidebar lesson clicked:', { moduleIndex, lessonIndex });
  ...
  return (
    <motion.div
      ...
      className={`${isMobile ? 'w-full' : 'w-80'} bg-card border-r flex-shrink-0 h-full overflow-hidden flex flex-col shadow-lg`}
    >
      {/* Header */}
                            ...
                            <CardContent className="p-4 w-full">
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3 flex-1 min-w-0">
                                  <div className="w-8 h-8 bg-gradient-to-br from-primary to-primary/80 rounded-lg flex items-center justify-center text-white text-sm font-bold">
                        ...
                        <CollapsibleContent>
                          <div className="border-t bg-muted/20">
                            {module.lessons.map((lesson, lessonIndex) => {
                              ...
                              console.log(`Rendering lesson: ${lesson.title}, Type: ${normalizedLesson.lesson_type}`);
