    ...
    <AppLayout>
      <div className="container max-w-4xl mx-auto py-8 px-4">
        <div className="flex flex-col gap-8">
          <div className="flex items-center gap-3 bg-gradient-to-r from-primary/20 via-primary/10 to-transparent p-5 rounded-xl shadow-sm">
            <div className="bg-primary/20 p-2.5 rounded-xl shadow-[0_0_10px_rgba(147,51,234,0.3)]">
          ...
          <Card className="shadow-md bg-card/95 border border-border/40">
            <CardHeader>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="startingFund">Starting Capital</Label>
                    <div className="relative">
