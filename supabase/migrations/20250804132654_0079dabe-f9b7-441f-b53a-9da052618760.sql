-- Fix the missing initial capital for user wigglee.trader@gmail.com
...
BEGIN
    ...
    FROM profiles 
    WHERE email = 'wigglee.trader@gmail.com';
    ...
    IF target_user_id IS NOT NULL THEN
        ...
        END IF;
    ELSE
        RAISE NOTICE 'User with email wigglee.trader@gmail.com not found';
    END IF;
END $$;